...
public class StickerContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        // This is the authority that should be in the library manifest! Changing this in one place only breaks things.
        this.authority = (getContext().getPackageName()) + ".stickercontentprovider";
        this.AUTHORITY_URI = AUTHORITY_URI = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority(authority).appendPath(StickerContentProvider.METADATA).build();
